...
#include "monster_generated.h" // This should be the generated header file from FlatBuffers schema
...
void MonsterSerializer::Serialize(flatbuffers::FlatBufferBuilder &builder)
{
    ...
    Vec3 position = Vec3(1.0f, 2.0f, 3.0f); // Assuming Vec3 is a struct from the schema
